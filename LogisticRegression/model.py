...
class SoftmaxRegression(LinearModel):
    ...
    def _softmax(self, x: np.ndarray) -> np.ndarray:
        ...
        # Shift each value by subtracting the max value in each input of the batch for numerical stability in the exponentiation step.
    ...
    def forward(self, x: np.ndarray) -> np.ndarray:
        ...
        # Apply the linear model first (Wx + b) to get logits.
        logits = super().forward(x)
        # Then apply the softmax function to get probabilities.
